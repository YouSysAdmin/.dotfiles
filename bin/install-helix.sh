...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for helix-editor/helix
...
execute() {
  ...
  cp -r "${tmpdir}/${NAME}/runtime" "${RUNTIME_DIR}/"
...
NAME=${PROJECT_NAME}-${REALTAG}-${ARCH}-${OS}
TARBALL=${NAME}.${FORMAT}
